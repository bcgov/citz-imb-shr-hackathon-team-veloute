...
oc process -f /home/runner/work/citz-imb-shr-hackathon-team-veloute/citz-imb-shr-hackathon-team-veloute/openshift/templates/api/$DC_TEMPLATE --namespace=$NAMESPACE \
